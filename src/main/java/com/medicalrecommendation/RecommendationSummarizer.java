...
public class RecommendationSummarizer {
    ...
    Map<String, String> recommendations) throws IOException {
        ...
        allRecsText.append("- ").append(paramName).append(": ").append(mainRecommendation).append("\n\n");
         ...
         + "4. SETIAP KATEGORI HARUS DALAM BENTUK PARAGRAF (BUKAN BULLET POINTS, BUKAN STRIP-STRIP)\n"
         ...
         + "   - Mulai dengan semua makanan/minuman yang DISARANKAN untuk dikonsumsi\n"
         + "   - Setelah itu baru bahas yang perlu DIHINDARI/DIBATASI\n"
         + "   - Contoh yang TERMASUK: jenis makanan, porsi, frekuensi makan, nutrisi, vitamin, mineral\n\n"
         + "   - PLEASE PLEASE PLEASE PLEASE NO MORE THAN 80 WORDS. SANGAT SANGAT PENTING: Jumlah kata HARUS BANGET CUMA BOLEH maksimal 80 kata dalam satu paragraf'\n\n"
         ...
         + "   - Buat sangat RINGKAS dan TO THE POINT tentang jenis, durasi, dan frekuensi olahraga\n"
         ...
         + "   -  PLEASE PLEASE PLEASE PLEASE NO MORE THAN 40 WORDS. PENTING: Jumlah kata HARUS BANGET CUMA BOLEH maksimal 40 kata dalam satu paragraf'\n\n"
         + "   - Pakainya kata Anda bukan nama'\n\n"
         ...
         + "   - Contoh yang TERMASUK: pola tidur, PENTING: jumlah jam tidur perlu dimention ya, manajemen stres, menghindari paparan debu/polusi, pemantauan tekanan darah\n"
         ...
         + "   - PLEASE PLEASE PLEASE PLEASE NO MORE THAN 40WORDS.PENTING: Jumlah kata HARUS BANGET CUMA BOLEH maksimal 40 kata dalam satu paragraf'\n\n"
         + "   - Pakainya kata Anda bukan nama'\n\n"
